...
const DEFAULT_TEMPLATE = 'Explore the %network_title% blockchain with CitreaScan. Track transactions, verify contracts, analyze addresses, and access complete blockchain data and APIs.';
...
const TEMPLATE_MAP: Record<Route['pathname'], string> = {
  ...
  '/gas-tracker': 'Explore real-time %network_title% gas fees with CitreaScan\'s advanced gas fee tracker. Get accurate %network_gwei% estimates and track transaction costs live.',
